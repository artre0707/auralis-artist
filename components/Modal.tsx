...
const Modal: React.FC<ModalProps> = ({ children, onClose, className, panelClassName }) => {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <MotionDiv
        className={`relative m-4 w-full max-w-lg rounded-2xl bg-[var(--card-strong)] border border-[var(--border)] shadow-xl p-6 ${panelClassName || ''}`}
